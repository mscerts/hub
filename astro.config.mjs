    ...
    sidebar: [
        ...
        },
        {
            ...
            items: [
              	...
              	{ label: 'DP-750 beta', link: 'https://learn.microsoft.com/en-us/credentials/certifications/implementing-data-engineering-solutions-using-azure-databricks?WT.mc_id=studentamb_165290' ,badge: { text: '80%', variant: 'tip' }, },
        ...
        },
        {
            ...
            collapsed: false,
            items: [
                { label: 'Azure', collapsed: true, items: [
                  { label: 'AZ-104', link: '/azure/az-104/' },
                  { label: 'AZ-120', link: '/azure/az-120/' },
                  { label: 'AZ-140', link: '/azure/az-140/' },
                  { label: 'AZ-204', link: '/azure/az-204/', badge: { text: 'RETIRING', variant: 'danger' }, },
                  { label: 'AZ-305', link: '/azure/az-305/' },
                  { label: 'AZ-400', link: '/azure/az-400/' },
                  { label: 'AZ-500', link: '/azure/az-500/', badge: { text: 'RETIRING', variant: 'danger' }, },
                  { label: 'AZ-700', link: '/azure/az-700/' },
                  { label: 'AZ-800', link: '/azure/az-800/', badge: { text: 'RETIRING', variant: 'danger' }, },
                  { label: 'AZ-801', link: '/azure/az-801/', badge: { text: 'RETIRING', variant: 'danger' }, },
                  { label: 'AZ-900', link: '/azure/az-900/' },
                  { label: 'DP-100', link: '/azure/dp-100/', badge: { text: 'RETIRING', variant: 'danger' }, },
                ...
                { label: 'GitHub', collapsed: true, items: [
                ...
                { label: 'AI & AB', collapsed: true, items: [
                  { label: 'AB-100', link: '/aiab/ab-100/' },
                  { label: 'AB-730', link: '/aiab/ab-730/' },
                  { label: 'AB-731', link: '/aiab/ab-731/' },
                  { label: 'AB-900', link: '/aiab/ab-900/' },
                  { label: 'AI-102', link: '/aiab/ai-102/', badge: { text: 'RETIRING', variant: 'danger' }, },
                  { label: 'AI-900', link: '/aiab/ai-900/', badge: { text: 'RETIRING', variant: 'danger' }, }, 
                ] },
                { label: 'Microsoft 365', collapsed: true, items: [
                ...
                { label: 'Security & Identity', collapsed: true, items: [
                ...
                { label: 'Power Platform', collapsed: true, items: [
                ...
                { label: 'Dynamics 365', collapsed: true, items: [
