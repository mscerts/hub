    ...
    sidebar: [
        ...
        },
        {
            ...
            items: [
                ...
                { label: 'Microsoft x Coursera', link: '/vouchers/microsoftxcoursera/' ,badge: { text: '*50%', variant: 'tip' }, },
                { label: 'Fabric Data Days 2025', link: '/vouchers/fabricdatadays2025/' ,badge: { text: '50-100%', variant: 'tip' }, },
