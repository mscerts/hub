...
description: "New site revamp - new theme, new pages, new blog, new everything! Several changes including changes to the style & theme and addition of the exam collection & a blog section."
authors:
  - name: "nighthouse"
...
pubDate: 2023-09-29
cardImage: "@images/blog/covers/new-revamp.png"
...
> **Hello World!**
> It's your local friendly contributor **nighthouse** here, and I'm here to announce that MSFTHub has been revamped! There's been a whole lot of changes, and I'm here to tell you about them.
...
> **Note:** A lot of the exams are still missing information and we would love for you to contribute, you can easily do so now by clicking the edit button on the bottom left of the pages.
...
**Technical Changes:** Minor internal changes, Starlight was updated to the latest version. A lot more internal Starlight components are being used now to make the look better and a new blog plugin was added to the site.
