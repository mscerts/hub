...
description: A program for people from non-technical backgrounds to help them transition careers
---
import { LinkButton } from '@astrojs/starlight/components';

<LinkButton
  href="https://powerup.microsoft.com/" target="_blank"
  variant="primary"
  icon="rocket"
  iconPlacement="start"
>
...
:::note
Get 100% off exam voucher after finishing the program 
:::
