...
It will be replaced by AB-410; Intelligent App Builder.

AB-410; Intelligent App Builder is coming to beta on April 21, 2026.
...
<Tabs>
  ...
  <TabItem label="Tests">
    <LinkCard title="MS Learn Practice Assessment" href="https://learn.microsoft.com/certifications/exams/pl-200/practice/assessment?assessment-type=practice&assessmentId=64&WT.mc_id=studentamb_165290" target="_blank" description="Mini test that shows examples of how exam questions are structured. It is not equivalent to the real exams in format/difficulty. It is easier than real exams."/>
    <CardGrid>
