...
<Aside type="danger">This guide is currently outdated as per Feb 2026 and will be updated soon.</Aside>
...
2. Install any package manager you want to use. We recommend pnpm due to it's performant and small size. 
   You can install pnpm by visiting the [official website](https://pnpm.io/installation) and following the instructions. You will also need to install a JavaScript runtime      environment called Node.js which can be done via [this website](https://nodejs.org/en/download).
