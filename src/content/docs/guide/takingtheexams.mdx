...
If you are taking a role-based/non-fundamental exam, you will have limited access to Microsoft Learn during your exam. The button will be right below the **Exam Progress** button.
...
You will enter a virtual environment and will have to complete a series of tasks there. The only thing that matters is to get the task done. So if you are more comfortable using Cloud Shell, go for it. It is only the result that counts. Be aware that you cannot use internet to search stuff up. 
