...
**Sources:**
  <LinkCard title="Prepare for an exam | Microsoft Learn" href="https://learn.microsoft.com/en-us/certifications/prepare-exam"/>
  <LinkCard title="Microsoft Learn for Exams | Techcommunity" href="https://techcommunity.microsoft.com/t5/microsoft-learn-blog/introducing-a-new-resource-for-all-role-based-microsoft/ba-p/3500870"/>
