...
For long term demo tenants (there are other resources but this is the most significant one), this is the best way to get them for free. There should be tenants for every feature you might need to test out. 
...
[Associate Microsoft Certification profile ID (MCID) to a Microsoft Cloud Partner Program | Microsoft Learn](https://learn.microsoft.com/partner-center/ms-learn-associate?WT.mc_id=studentamb_165290)
