...
**Sources:**
  <LinkCard title="Associate Microsoft Certification profile ID (MCID) to a Microsoft Cloud Partner Program | Microsoft Learn" href="https://learn.microsoft.com/en-us/partner-center/ms-learn-associate" />
