...
You can find the Dashboard here: [Certification Dashboard](https://learn.microsoft.com/en-us/users/me/credentials?tab=credentials-tab). It was recently migrated into the Microsoft Learn profile which helps keep information at one place but as always, Microsoft likes to break stuff that actually works.
