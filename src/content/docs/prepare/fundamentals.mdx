...
5. Use the [study-material guide](/certs/prepare/studymaterials/) and [collection for your exam](/certs) when you need another explanation, Exam Readiness Zone videos, or more practice.
6. For practical familiarity, use the [lab setup guide](/certs/prepare/labs/) and browse the [exam lab collections](/certs/labs/).
7. Use the [exam sandbox and exam-experience guide](/certs/guide/takingtheexams/) before exam day. Fundamentals exams do not provide access to Microsoft Learn during the exam.
</Steps>
